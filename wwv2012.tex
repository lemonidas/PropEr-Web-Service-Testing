...
specified there, created test case generators and a property, called
\texttt{prop\_ChangeCookingUnit\_responds}. It then performed 100
random tests on the web service using this property and the web
service responded with valid SOAP messages on all of them. Our tool
however, is designed for more. Optionally, it allows the user to
...
\begin{figure}[!b]
\centering
\includegraphics[height=.26\textheight]{Framework.png}

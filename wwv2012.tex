...
\lstnewenvironment{lstoutput}[1][]{%
  \lstset{language=erlang,frame=trBL,frameround=tttt,
          ...
          xleftmargin=2em,xrightmargin=2em,#1}%
}{}
...
\def\titlerunning{Automatic WSDL-guided Test Case Generation for PropEr Testing of Web Services}
...
% In addition, we present some example uses of these generators in
% automatically testing web services for unexpected behaviors.

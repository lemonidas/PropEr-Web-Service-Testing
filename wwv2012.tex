...
Yaws it must be converted to String before wrapped in a valid SOAP structure, 
the second argument states that the base PropEr generator is \texttt{integer()} and the 

...
Include code differently?
$<<$ instead of bsl?

\begin{center}
  \begin{tabular}{cc}
    Simple Type & Erlang IR\\[5pt]
...
datatypes into complex ones. In an XSD schema, there are 3 main combinators for
...
\texttt{Type\_name} variable, and the generators of the "elements" of the complex
type in the \texttt{Generators} variable. 

\begin{center}
  \begin{tabular}{cc}
    Indicator & Erlang IR\\[5pt]
    all & \texttt{\{Type\_name, \{tuple, Generators\}\}}\\
    sequence & \texttt{\{Type\_name, \{tuple, Generators\}\}}\\
    choice & \texttt{\{Type\_name, \{union, Generators\}\}}
  \end{tabular}
\end{center}
...
This is only possible with the use of the \texttt{?LET} macro that allows you to modify and combine the 
generated data. 

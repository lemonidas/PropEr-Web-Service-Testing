...
fully-automated response testing on a free web service.

\begin{lstlisting}
> proper_ws:auto_test("http://www.webservicex.net/ConvertCooking.asmx?WSDL").
...
In this example, 100 random tests were performed on the web service, 
and the web service responded successfully on all of them. Our tool
however, is designed for more. Optionally, it allows the user to easily
modify the created generators and properties in order to test 
